    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>Presidency University, Gulshan 2, Dhaka</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="input-box">
                    <iframe class="map"
                        src="https://www.google.com/maps/@23.79634,90.417395,15z?hl=en&entry=ttu"
                        loading="lazy"></iframe>
                </div>
            </div>
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.orderObj.phone) {
                ...
                if (!this.orderObj.phone.startsWith('01')) {
                    this.errorObj.phoneErr.push('Phone numbers must start with 01');
                }
