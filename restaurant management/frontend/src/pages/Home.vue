<template>
    <div>
        <div class="home-main">
            <div class="content">
                <span>welcome PU foodies</span>
                <h3>Original taste from Presidency University 😋</h3>
                <p>We guarantee to use fresh food with the best quality. Customers will enjoy our delicious food with
        ...
        <div class="home-category">
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/Rice/rice.jpg" alt="">
                <h3>Rice</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/Burger/chicken-burger.jpg" alt="">
                <h3>Burger</h3>
            </router-link>
            ...
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/Pizza/Chicken-Pizza.jpg" alt="">
                <h3>Pizza</h3>
            </router-link>
